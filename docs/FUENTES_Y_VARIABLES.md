...
| NASA Black Marble monthly | SERIE COMPLETA (2026-07-22): `blackmarble_monthly.csv`, 149 meses 2014-01 a 2026-05, radiancia promedio pais (VNP46A3 NearNadir Snow-Free, 5 tiles, mascara geojson). VALIDACION vs serie anual Li et al. (11 años completos 2014-2024): Pearson r=+0.649 (p=0.031), Spearman rho=+0.673 (p=0.023) — consistencia positiva significativa pero moderada. Ambas series coinciden en el colapso 2014-2020; divergen despues de 2022: Li et al. sigue cayendo mientras Black Marble muestra recuperacion parcial (coherente con el comercio espejo y la produccion petrolera). Las diferencias esperables: productos distintos (armonizado DMSP-like vs radiancia cruda), mascaras y tratamiento de flaring petrolero. DECISION: capa auxiliar; NO entra al Pulse hasta analizar variantes de agregacion (log-media, mediana, pixeles urbanos) y decidir peso + backtest. El workflow semanal mantiene la serie al dia (--months 4) | token Earthdata expira cada ~60 dias (regenerar y actualizar secret) |
